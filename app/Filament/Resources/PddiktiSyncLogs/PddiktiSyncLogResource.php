...
class PddiktiSyncLogResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            TextInput::make('entity_type')->required(),
            TextInput::make('entity_id')->required(),
            TextInput::make('operation')->required(),
            ...
            TextInput::make('retry_count')->numeric()->disabled(),
            TextInput::make('response_code')->numeric()->disabled(),
            Textarea::make('response_message')->disabled()->columnSpanFull(),
        ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            TextColumn::make('last_attempt_at')->dateTime(),
        ])->actions([
            EditAction::make(),
            Action::make('retry')
                ->label('Retry')
