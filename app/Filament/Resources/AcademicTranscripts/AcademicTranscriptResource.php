    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Action::make('finalize')
                ->label('Finalisasi')->icon(Heroicon::OutlinedLockClosed)->color('warning')->requiresConfirmation()
            ...
            Action::make('sign')
                ->label('Tanda Tangani')->icon(Heroicon::OutlinedPencilSquare)->color('success')
            ...
            Action::make('verify_signature')
                ->label('Verifikasi')->icon(Heroicon::OutlinedShieldCheck)->color('info')
            ...
            Action::make('export_pdf')
                ->label('PDF')->icon(Heroicon::OutlinedDocumentArrowDown)
            ...
            Action::make('export_excel')
                ->label('Excel')->icon(Heroicon::OutlinedTableCells)
                ->visible(fn(AcademicTranscript $record): bool => $record->status === 'final')
